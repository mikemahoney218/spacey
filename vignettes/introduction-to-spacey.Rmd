...
```{r, include=FALSE}
knitr::include_graphics("../man/figures/README-johns_brook_basic-1.png")
```
...
```{r include=FALSE}
knitr::include_graphics("../man/figures/README-johns_brook_overlay-1.png")
```
...
```{r include=FALSE}
knitr::include_graphics("../man/figures/README-johns_brook_3d-1.png")
```
